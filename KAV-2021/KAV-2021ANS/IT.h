...
#define ID_MAXSIZE		26 //макс кол-во символов в итендификаторе
#define ID_CURRENT_MAXSIZE		10 //макс кол-во символов в итендификатора

#define	TI_MAXSIZE		4096 //макс кол-во строк в табл итендификаторов
#define TI_INT_DEFAULT	0x00000000	//значение uint по дефолту
